...
public sealed class RabbitMqMessagePublisherTests
{
    ...
    public async Task PublishAsync_WhenMessageIsValid_PublishesWithCorrelationHeader()
    {
        ...
        var options = Options.Create(new RabbitMqOptions
        {
            ...
            OutboundQueueName = "orders" // Use OutboundQueueName instead of QueueName
        });
        ...
        channel.Setup(c => c.QueueDeclareAsync(
                options.Value.OutboundQueueName, // Use OutboundQueueName instead of QueueName
                true,
                false,
                false,
                null,
            ...
            .ReturnsAsync(new QueueDeclareOk(options.Value.OutboundQueueName, 0, 0));
        ...
        try
        {
            ...
            // Assert
            capturedRoutingKey.Should().Be(options.Value.OutboundQueueName);
